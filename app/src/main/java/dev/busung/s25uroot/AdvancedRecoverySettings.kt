...
internal fun AdvancedRecoverySettings(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Text(
            ...
            style = MaterialTheme.typography.bodySmall,
            color = HudColors.WarningAmber.copy(alpha = if (autoRootEnabled) 1f else 0.82f),
...
private fun HoldRecoveryCard(
    ...
    Card(
        ...
        border = androidx.compose.foundation.BorderStroke(
            1.dp,
            if (destructive) HudColors.WarningAmber.copy(alpha = 0.5f)
        ...
        Row(
            ...
            if (busy) {
                ...
                Icon(
                    ...
                    modifier = Modifier.size(28.dp),
                    tint = if (destructive) HudColors.WarningAmber else HudColors.Blood,
                )
            }
...
@Composable
private fun recoveryShape(top: Boolean = false, bottom: Boolean = false): Shape =
    hudCutShape(if (top || bottom) 14.dp else 8.dp)
